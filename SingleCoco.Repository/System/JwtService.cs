...
{
    public class JwRepository : IJwtRepository
    {
        ...
        public JwRepository(IDistributedCache cache, IHttpContextAccessor httpContextAccessor, IConfiguration configuration)
        {
            _cache = cache;
